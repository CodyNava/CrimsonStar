...
namespace _01_Scripts.Ship
{
    ...
    public class CameraZoomSettings : ScriptableObject
    {
        ...
        [field:Tooltip("Sets the general zoom speed")]
        [AbsoluteValue] [field:SerializeField] public float ZoomSpeedFactor { get; private set; }
        
        [field:Tooltip("This enables exponential zoom speed. For example the zoom speed is faster if zoomed far out as if it is very zoomed in")]
